...
if ( window.odkTablesIf === null || window.odkTablesIf === undefined ) {
  window.odkTablesIf = {

    setSubListView : function(tableId, sqlWhereClause,
                              sqlSelectionArgsJSON, relativePath) {
      ...
      window.parent.setSubListView("org.opendatakit.tables.activities.TableDisplayActivity",
                                   intentArgs, window.location );
      return true;
    },


    setSubListViewArbitraryQuery : function(tableId, sqlCommand,
                              sqlSelectionArgsJSON, relativePath) {
