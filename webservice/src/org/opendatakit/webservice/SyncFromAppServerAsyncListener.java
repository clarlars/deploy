...
public class SyncFromAppServerAsyncListener implements AsyncListener {
	private static final String TAG = "SyncFromAppServerAsyncListener";
	  ...
	  SyncFromAppServerAsyncListener(AsyncContext  asyncContext, String appName) {
	    ...
	    asyncContext.start(new Runnable() {
			...
			public void run() {
			    ...
			    try {
			      ...
			      final GlobalSyncNotificationManagerImpl notificationManager = new GlobalSyncNotificationManagerImpl(appContext);
			      ...
			      // on the tools.
			      AppSynchronizer sync = new AppSynchronizer(appContext,
			                "214", appName, notificationManager);
