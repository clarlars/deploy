...
/**
 * Servlet implementation class OdkDataHostIf
 */
...
public class OdkDataHostIf extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     OdkData theData = new OdkData(action, theViewImpl);
       ...
       List<String> groupByList = (List<String>) theRequest.get(OdkData.IntentKeys.SQL_GROUP_BY_ARGS);
       ...
       String orderByElementKey = (String) theRequest.get(OdkData.IntentKeys.SQL_ORDER_BY_ELEMENT_KEY);
       ...
       theData.query(tableId, whereClause, sqlBindParamsJSON, groupBy, having, 
           orderByElementKey, orderByDirection, limit, offset, includeKeyValueStoreMap, metaDataRev, callbackJSON);
       ...
       Integer offset = (Integer) theRequest.get("offset");
       String metaDataRev = (String) theRequest.get(OdkData.IntentKeys.META_DATA_REV);
       theData.arbitraryQuery(tableId, sqlCommand, sqlBindParamsJSON, limit, offset, metaDataRev, callbackJSON);
       ...
       String rowId = (String) theRequest.get(OdkData.IntentKeys.ROW_ID);
       String metaDataRev = (String) theRequest.get(OdkData.IntentKeys.META_DATA_REV);
       theData.changeAccessFilterOfRow(tableId, defaultAccess, rowOwner, 
           groupReadOnly, groupModify, groupPrivileged, rowId, metaDataRev, callbackJSON);
       ...
       String rowId = (String) theRequest.get(OdkData.IntentKeys.ROW_ID);
       String metaDataRev = (String) theRequest.get(OdkData.IntentKeys.META_DATA_REV);
       theData.saveCheckpointAsIncomplete(tableId, stringifiedJSON, rowId, metaDataRev, callbackJSON);
